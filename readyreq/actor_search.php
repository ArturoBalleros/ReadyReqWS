...
if (empty($param))
	...
	if ($param_conn == "No")
		...
		if ($conexion == "No")
			...
			$consulta = "Select * from Actores where Id = '" . $param . "';";
			...
			if (!$resultado)
				...
				$consulta = "Select g.Id as Id, g.Nombre as Nombre from Grupo g, ActAuto aa where g.Id = aa.IdAutor and aa.IdAct = " . $param . " Order By Categoria Desc, Nombre;";
				$resultado = mysqli_query($conexion, $consulta);
				...
				if (!$resultado)
					...
					$consulta = "Select g.Id as Id, g.Nombre as Nombre from Grupo g, ActFuen af where g.Id = af.IdFuen and af.IdAct = " . $param . " Order By Categoria Desc, Nombre;";
					$resultado = mysqli_query($conexion, $consulta);
